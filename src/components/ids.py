...
SADDLE_POINT_BUTTON = 'saddle-point-button'
LOWER_BOUNDARY_INPUT = 'lower-boundary-input'
UPPER_BOUNDARY_INPUT = 'upper-boundary-input'
CONFIRM_SP_EVALUATION = 'confirm-saddle-point-evaluation'